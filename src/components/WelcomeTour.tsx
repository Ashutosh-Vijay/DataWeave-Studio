...
const STEPS: Step[] = [
  ...
  { sel: 'sidebar', side: 'right', kicker: 'Tests', tag: 'NEW', title: 'Real dw::test suites',
    desc: 'Scripts and test suites are separate entries in the workspace, each with its own name — add a suite from the Tests list on the left. Write named assertions with the same framework MuleSoft ships; failures come back with the engine’s own message and the line that failed.',
    tip: 'Whatever you select is what Run, Save and Share act on.' },
