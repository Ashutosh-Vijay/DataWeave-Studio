...
const STEPS: Step[] = [
  ...
  { sel: 'run-controls', side: 'bottom', kicker: 'Run', title: 'Run the transform',
    ...
    tip: '⌘↵ runs; leave Auto on for a live preview as you type.' },
  ...
  { sel: 'target-runtime', side: 'bottom', kicker: 'Target runtime', tag: 'NEW', title: 'Check against the Mule you deploy to',
    desc: 'The engine here is the newest DataWeave. Point this at your actual runtime and anything too new — a 2.10 function on Mule 4.4, say — fails here instead of on the server.',
    tip: 'Set once, applies everywhere. Settings → Runtime can make it per-workspace.' },
  ...
  { sel: 'sidebar', side: 'right', kicker: 'Toolbox', title: 'It all lives in the rail',
    desc: 'Function reference, cookbook, flows, the Java tester, your module library, secure properties, compare and the OpenAPI reader all dock from the left rail. ⌘B toggles it; ⌘K opens any of them by name.',
