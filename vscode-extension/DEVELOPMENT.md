# Development notes — DataWeave Studio VS Code extension

(Internal docs — how the extension shares code with the desktop app and how to
build/package it. The user-facing Marketplace page is README.md.)
